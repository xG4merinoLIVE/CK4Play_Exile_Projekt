		...
		class Exile // Exile specific settings
			{
				...
				aiMoney = 125; // (max) amount of money that AI will have on them
				crateMoney = 1225; // (max) amount of money in the loot crate
				...
				class DynamicLocationInvasion // DynamicLocationInvasion (mission) settings
					{
						...
						class crateLootVanilla // Loot crate configuration (vanilla items)
							{
								...
								itemsExile[] = {
									...
									{ "Exile_Item_HBarrier5Kit", 1 }, { "Exile_Item_Heatpack", 4 }, { "Exile_Item_InstaDoc", 4 }, { "Exile_Item_InstantCoffee", 4 }, { "Exile_Item_Knife", 2 }, { "Exile_Item_Laptop", 1 }, { "Exile_Item_LightBulb", 2 },
						...
						class crateParachute
							{
								enabled = yes; // enable/disable parachute of the loot crate
								altitude = 250; // loot crate spawn-altitude in meters
							};

						crateTypes[] = { "I_CargoNet_01_ammo_F" };
						...
						class heliPatrol
							{
								...
								locked = yes; // enable/disable heli lock to prevent/allow players from flying it
							};
		...
		class aiSkill
			{
				...
				class Easy { accuracy = 0.4; aimingShake = 0.20; aimingSpeed = 0.3; endurance = 0.25; spotDistance = 0.5; spotTime = 0.65; courage = 1; reloadSpeed = 0.3; commanding = 1; general = 0.3; };
				class Normal { accuracy = 0.4; aimingShake = 0.20; aimingSpeed = 0.3; endurance = 0.25; spotDistance = 0.5; spotTime = 0.65; courage = 1; reloadSpeed = 0.3; commanding = 1; general = 0.4; };
				class Veteran { accuracy = 0.4; aimingShake = 0.20; aimingSpeed = 0.3; endurance = 0.25; spotDistance = 0.5; spotTime = 0.65; courage = 1; reloadSpeed = 0.3; commanding = 1; general = 0.5; };
				class Hardcore { accuracy = 0.4; aimingShake = 0.20; aimingSpeed = 0.3; endurance = 0.25; spotDistance = 0.5; spotTime = 0.65; courage = 1; reloadSpeed = 0.3; commanding = 1; general = 0.7; };
			};
