	...
	class ItemGroups
	{
		...
		*/
		...
		/*
			...
			Exile_Item_CordlessScrewdriver	= 4,55%
			Exile_Melee_SledgeHammer        = 5,20%
			Exile_Item_ExtensionCord        = 5,26%
			Exile_Item_LightBulb            = 5,52%
			Exile_Item_Knife                = 5,92%
...
class CfgSettings
{
    ...
    {    
        ...
        * after you are satisfied with vehicle ammount and spread set this to 0.
        */
        groundDebugMarkers = 0; //"0"=Disabled "1"=Enabled
        waterDebugMarkers = 0; //"0"=Disabled "1"=Enabled
        airDebugMarkers = 0; //"0"=Disabled "1"=Enabled
        /**
