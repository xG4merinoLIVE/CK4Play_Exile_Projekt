...
class VirtualGarageDialog
{
	...
	class Controls
	{
        ...
        {
        	idc = 1105;
            text = "$STR_HOPE_NATION_VIRTUALGARAGE_CLOSE";
        ...
        class VirtGarageStoreBtnText: VirtGarageRscStructuredText
        {
        	...
        	text = "$STR_HOPE_NATION_VIRTUALGARAGE_STORE"; //--- ToDo: Localize;
        ...
        class VirtGarageRetrieveBtnText: VirtGarageRscStructuredText
        {
        	...
        	text = "$STR_HOPE_NATION_VIRTUALGARAGE_RETRIEVE"; //--- ToDo: Localize;
        	x = 0.407212 * safezoneW + safezoneX;
