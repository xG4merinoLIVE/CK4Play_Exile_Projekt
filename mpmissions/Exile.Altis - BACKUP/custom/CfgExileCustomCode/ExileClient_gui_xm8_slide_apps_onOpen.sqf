...
_AppsLogo = "custom\xm8Apps\images\appmenu.paa";
...
_newControl ctrlSetEventHandler ["ButtonClick", "execVM'custom\xm8Apps\XM8Apps_Init.sqf';"];
_newControl ctrlSetStructuredText (parseText (format ["CK4Play APPS"]));
};
