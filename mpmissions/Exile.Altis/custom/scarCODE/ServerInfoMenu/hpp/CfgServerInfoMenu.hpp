class CfgServerInfoMenu
{
   ...
   hostedBy = "CK4Play Commnuity";
   ipPort = "89.163.140.220:3202";
   ...
   serverName = "[ GERMAN/PVE ] CK4Play Community Server";
   class menuItems
   {
      ...
      class third
      {
         ...
         content[] = {"<t size='1.75'>Server Developer</t><br /><t color='#c72651'>+</t> xG4merinoLIVE<br />",
					  "<t size='1.75'>Unser Adminteam</t><br /><t color='#c72651'>+</t> xG4merinoLIVE <br /><t color='#c72651'>+</t> Gnob25<br /><t color='#c72651'>+</t> Murphy<br />"};
      };
      class fourth
      {
         menuName = "Scripts";
         ...
         content[] = {"<t size='1.75'>MapContent</t><br /> <t color='#c72651'>+</t> Pyrgos Militärcamp<br /> <t color='#c72651'>+</t> Airfield Safezone ( Parkplatz )<br />",
					  "<t size='1.75'>AI Missions</t><br /> <t color='#c72651'>+</t> VEMFr Missions<br /> <t color='#c72651'>+</t> A3XAI ( Es Spawnen AI und AI Fahrzeuge in Städten )<br /> <t color='#c72651'>+</t> DMS<br />",
					  "<t size='1.75'>XM8 Apps</t><br /> <t color='#c72651'>+</t> Server Regel APP<br /> <t color='#c72651'>+</t> Base Marker APP<br /> <t color='#c72651'>+</t> Crafting APP<br />",
					  "<t size='1.75'>Virtual Garage</t><br /> <t color='#c72651'>+</t> Funktion findest du an einem BaseLaptop.<br />",
					  "<t size='1.75'>Weitere Scripts</t><br /> <t color='#c72651'>+</t> StatusBar<br /> <t color='#c72651'>+</t> Lottery System ( Lose kaufen und Preise Gewinnen )<br /> <t color='#c72651'>+</t> Igiload ( Transportiere Fahrzeuge und Missionkisten )<br /> <t color='#c72651'>+</t> Advanced Towing<br /> <t color='#c72651'>+</t> Loyalty System<br /> <t color='#c72651'>+</t> Deploy Bike (Doppelklick auf das Funkgerät im Inventar)<br /><br /><br /><br />"};
      };
      class fifth
      {
         menuName = "Base infos";
      ...
      class sixth
      {
         ...
         content[] = {
            "<t size='1.25'>Forum:</t> forum.ck4play.de <br />",
			"<t size='1.25'>Teamspeak Server:</t> ck4play.de <br />",
      ...
      class seventh
      {
         ...
         content[] = {
            "<t size='1.25'>IT07:</t> server creater:",
            "<br />",
            "<t size='1.25'>Name:</t> xG4merinoLIVE.GER"
         };
      };
   };
};
