...
if(_response == "true")then
{
  ...
  ["SuccessTitleAndText", [ localize "STR_HOPE_NATION_VIRTUALGARAGE", localize "STR_HOPE_NATION_VIRTUALGARAGE_SUCCESSRETRIEVE"]] call ExileClient_gui_toaster_addTemplateToast;
}
else
{
  ["ErrorTitleAndText", [ localize "STR_HOPE_NATION_VIRTUALGARAGE", localize "STR_HOPE_NATION_VIRTUALGARAGE_NOTRETRIEVE"]] call ExileClient_gui_toaster_addTemplateToast;
};
