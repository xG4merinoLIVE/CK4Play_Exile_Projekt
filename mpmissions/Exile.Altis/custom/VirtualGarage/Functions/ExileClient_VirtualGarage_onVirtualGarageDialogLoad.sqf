...
_setLoadingText ctrlSetStructuredText parseText Format[ localize "STR_HOPE_NATION_VIRTUALGARAGE_LOADING"];
...
_VirtGarageStoredVehiclesTitle ctrlSetStructuredText parseText Format[ localize "STR_HOPE_NATION_VIRTUALGARAGE_STOREDVEHICLES"];
_VirtGarageTitle = (_display displayCtrl 1101);
_VirtGarageTitle ctrlSetStructuredText parseText Format[ localize "STR_HOPE_NATION_VIRTUALGARAGE_CAPSLOCK"];
_VirtGarageNearbyVehiclesTitle = (_display displayCtrl 1102);
_VirtGarageNearbyVehiclesTitle ctrlSetStructuredText parseText Format[ localize "STR_HOPE_NATION_VIRTUALGARAGE_NEARBYVEHICLES"];
