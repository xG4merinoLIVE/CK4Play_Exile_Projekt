...
_maxVeiwDist = 10000; //Maximum Veiw Distance

_minObjViewDist = 500; //Minimum Object Veiw Distance
_maxObjViewDist = 10000; //Maximum Object Veiw Distance
/////////////////
//CONFIG END
////////////////
...
//set XM8 title
(_display displayCtrl 4004) ctrlSetStructuredText (parseText (format [ localize "STR_HOPE_NATION_VIEWDISTANCE_TITEL"]));
...
_GoBackBtn ctrlSetText localize "STR_HOPE_NATION_VIEWDISTANCE_GOBACK";
