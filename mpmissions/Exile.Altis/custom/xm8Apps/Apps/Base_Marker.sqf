...
_xm8Controls = [991,881,992,882,993,883,994,884,995,885,996,886,997,887,998,888,999,889,9910,8810,9911,8811,9912,8812,9913,8813,9914,8814,9915,8815];
{
...
(_display displayCtrl 4004) ctrlSetStructuredText (parseText (format [ localize "STR_HOPE_NATION_BASEMARKER"]));
...
_OnBtn ctrlCommit 0;
_OnBtn ctrlSetText localize "STR_HOPE_NATION_BASEMARKER_ON";
...
_OffBtn ctrlSetText localize "STR_HOPE_NATION_BASEMARKER_OFF";
...
_BackBtn ctrlSetText localize "STR_HOPE_NATION_BASEMARKER_GOBACK";
...
_Instruction ctrlSetStructuredText parseText localize "STR_HOPE_NATION_BASEMARKER_VISIBLE";
...
fnc_Back = {
		...
		execVM "custom\xm8Apps\XM8Apps_Init.sqf";
		Sleep 1;
		{
		ctrlDelete ((findDisplay 24015) displayCtrl _x);
		} forEach _vdCtrls;
...
fnc_markerOff = {
		...
		forEach (allMissionObjects "Exile_Construction_Flag_Static");
		(findDisplay 24015) closeDisplay 0;
		//["Whoops",["Base Marker nicht mehr sichtbar."]] call ExileClient_gui_notification_event_addNotification;					//ALTE NOTIFICATION
		["ErrorTitleAndText", [ localize "STR_HOPE_NATION_BASEMARKER_TITEL", localize "STR_HOPE_NATION_BASEMARKER_TEXT_NO_VISIBLE"]] call ExileClient_gui_toaster_addTemplateToast;
