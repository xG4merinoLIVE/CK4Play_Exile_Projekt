...
class CfgA3XAISettings {
	...
	landVehicleList[] = {
		{"Exile_Car_Hatchback_Black",1},
		{"Fox_CobraR_Police",2},
		{"Exile_Car_SUVXL_Black",2},
		{"Exile_Car_Octavius_Black",1},
	...
	*/
	...
	addHeadgearChance0 = 1.00;
	addHeadgearChance1 = 1.00;
	addHeadgearChance2 = 1.00;
	...
	*/
	...
	//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	uniformTypes0[] = {"U_C_Scientist"};
	uniformTypes1[] = {"U_C_Scientist"};
	uniformTypes2[] = {"U_C_Scientist"};
	uniformTypes3[] = {"U_C_Scientist"};
	...
	headgearTypes0[] = {"H_Shemag_tan"};
	headgearTypes1[] = {"H_Shemag_tan"};
	headgearTypes2[] = {"H_Shemag_tan"};
	headgearTypes3[] = {"H_Shemag_tan"};
	...
	//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	gadgetsList0[] = {
		{"binocular",0.30},{"Exile_Headgear_GasMask",0.99}
	};
	gadgetsList1[] = {
		{"binocular",0.50},{"Exile_Headgear_GasMask",0.99}
	};
	gadgetsList2[] = {
		{"binocular",0.70},{"Exile_Headgear_GasMask",0.99}
	};
	gadgetsList3[] = {
		{"binocular",0.90},{"Exile_Headgear_GasMask",0.99}
	};
};
